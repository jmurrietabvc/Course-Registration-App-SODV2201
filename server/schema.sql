...
CREATE TABLE term_course(
	...
	course_id					INT FOREIGN KEY REFERENCES course(course_id) ON DELETE CASCADE
);
...
CREATE TABLE course_student(
	course_student_id			INT IDENTITY(1,1) PRIMARY KEY,
	course_id					INT FOREIGN KEY REFERENCES course(course_id) ON DELETE CASCADE,
...
INSERT INTO course (course_id, course_code, course_name, course_description, course_fees) VALUES 
(1,'Pr111', 'Project management1', 'This course provides a comprehensive introduction to the essential principles and practices of project management.Whether you re a novice or looking to brush up on your skills, you will gain a solid foundation in planning, execution, and monitoring of projects, equipping you with the knowledge and tools needed to successfully lead and contribute to a wide range of endeavors.', 2000.00),
(2,'C++111', 'C++ Programming Fundamentals', 'In this course, you will delve into the core concepts of C++, including data types, variables, control structures, functions, and object-oriented programming principles. You will gain practical experience through hands-on coding exercises, projects, and real-world applications.', 1000.00),
(3, 'CompM1111', 'Computer Maintenance', 'Discover the essential skills to keep your computer running smoothly with our Computer Maintenance course. Whether you are a tech enthusiast, a business professional, or just an everyday computer user, this course is designed to empower you with the knowledge and techniques needed to maintain and troubleshoot your computer hardware and software.', 3000.00),
(4, 'IS1111', 'Information Security1', 'This course provides a comprehensive introduction to the principles, concepts, and practices of safeguarding sensitive data and systems. Explore the fundamentals of cybersecurity, risk management, encryption, and threat detection. Gain the knowledge and skills to protect valuable information assets and mitigate digital threats.', 1000.00),
...
(7, 'Pr222', 'Project Management2', 'This course is designed to take your project management skills to the next level. Explore advanced techniques, tools, and strategies to successfully lead and deliver complex projects. Learn how to tackle challenging project scenarios, optimize resource allocation, and ensure project success from start to finish.', 1000.00),
...
-- Dummy data for the 'term_course' table
 INSERT INTO term_course (term_id, course_id) VALUES
(1,1),
(1,2),
(1,3),
(1,4),
...
-- Dummy data for the 'course_student' table
